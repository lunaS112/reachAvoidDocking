...
python3 run_experiment.py --mode train --experiment_name Docking6D_RA --dynamics_class Docking6D --tMax 30 --pretrain --pretrain_iters 1000 --num_epochs 13000 --counter_end 10000 --num_nl 128 --set_mode reach_avoid --lr 5e-5 --num_iterative_refinement 10 --MPC_batch_size 1000 --num_MPC_batches 5 --num_MPC_data_samples 500 --numpoints 5000 --use_wandb --wandb_project Docking6D --wandb_name Docking6D_RA --wandb_group Docking6D --wandb_entity santiagothorup-stanford-university
